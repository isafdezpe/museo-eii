...
En primer lugar quiero agradecer a mi familia, por su apoyo y su esfuerzo a lo largo de estos años para que pudiera estudiar esta carrera en las mejores condiciones posibles.\par
También a Redondo, por darme la oportunidad de desarrollar este proyecto, y por ser el mejor tutor que podría haber tenido. Es toda una suerte contar con profesores como él. \par
Por último, a mis amigos, porque siempre han estado para apoyarme y darme ánimos. En especial a Diego, por ser mi acompañante a diario, el que ha vivido conmigo el desarrollo de este TFG desde el inicio, por ayudarme a seguir adelante en los momentos en los que no puedo sola. Gracias.
...
\input{2-PSI-Planificacion}
%\input{3-PSI-Definicion}
\input{4-EVS}
\input{5-Planificacion y gestion}
\input{6-Analisis}
\input{7-Diseño}
\input{8-Construccion}
%\input{9-Implantacion y aceptacion}
