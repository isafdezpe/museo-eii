...
\end{figure}
\paragraph*{Añadir periodo}
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{añadirPeriodoIU}
\caption{Prototipo: Formulario para añadir un periodo}
\end{figure}
\paragraph*{Editar periodo}
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{editarPeriodoIU}
\caption{Prototipo: Formulario para editar un periodo}
\end{figure}
\paragraph*{Añadir componente}
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{añadirCompIU}
\caption{Prototipo: Formulario para añadir un componente}
\end{figure}
\paragraph*{Editar componente}
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{editarCompIU}
\caption{Prototipo: Formulario para editar un componente}
\end{figure}
